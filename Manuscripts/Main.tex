...
\begin{table}[htbp]
   ...
   \begin{tabular}{lccc}
      ...
      \midrule
      \emph{Variables}\\
      Hur\_Threat                                             & 0.1073         & -0.8372$^{**}$  & 1.155$^{***}$\\   
                                                              & (0.1564)       & (0.3462)        & (0.1954)\\   
      Hur\_Landfall                                           & 0.4481$^{***}$ & 1.363$^{***}$   & -0.5641$^{**}$\\   
                                                              & (0.0683)       & (0.1631)        & (0.1926)\\   
      temp\_mean                                              & 0.0046$^{***}$ & 0.0048$^{***}$  & 0.0066$^{***}$\\   
                                                              & (0.0010)       & (0.0010)        & (0.0010)\\   
      total\_hist\_landfall                                   &                & -0.0831$^{***}$ & -0.0779$^{**}$\\   
                                                              &                & (0.0265)        & (0.0290)\\   
      Hur\_Threat $\times$ total\_hist\_landfall              &                & 0.0662$^{*}$    &   \\   
                                                              &                & (0.0319)        &   \\   
      Hur\_Landfall $\times$ total\_hist\_landfall            &                & -0.0653$^{***}$ &   \\   
                                                              &                & (0.0121)        &   \\   
      years\_since\_landfall\_hur                             &                &                 & 0.0065\\   
                                                              &                &                 & (0.0078)\\   
      ...
      \midrule
      \emph{Fit statistics}\\
      Observations                                            & 448,123        & 448,123         & 217,176\\  
      R$^2$                                                   & 0.77057        & 0.77291         & 0.79158\\  
      \midrule \midrule
...
\begin{figure}[h!]
   \centering
	...
	\end{subfigure}
    \caption{Placebo test of total Exposure}
    \label{fig:plac_hist}
        \floatfoot{Note: Results from event study with subsets based on the years that have passed since that last storm made landfall in a county. The vertical axis represents total revenue per 100 thousand residents in USD. The horizontal axis represents weeks. Week 0 is the week that a tropical hurricane made landfall in a county. The bars represent the 5\% confidence interval around the point estimate.}
\end{figure}
...
\begin{figure}[h!]
   \centering
	...
	\end{subfigure}
    \caption{Placebo test of years between}
    \label{fig:disc_full}
        \floatfoot{Note: Results from event study with subsets based on the years that have passed since that last storm made landfall in a county. The vertical axis represents total revenue per 100 thousand residents in USD. The horizontal axis represents weeks. Week 0 is the week that a tropical hurricane made landfall in a county. The bars represent the 5\% confidence interval around the point estimate.}
\end{figure}
