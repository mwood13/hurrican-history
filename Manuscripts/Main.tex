...
\begin{figure}[t!]
	...
	\begin{subfigure}{0.45\linewidth}
		\caption{Price}
		\includegraphics[width=\linewidth]{ES Agg Price.png}
	\end{subfigure}
...
\begin{table}[htbp]
   ...
   \begin{tabular}{lccc}
      ...
      \midrule
      \emph{Variables}\\
      Threat                                 & 0.1073         & 0.1220          & -0.8372$^{**}$\\   
                                             & (0.1564)       & (0.1670)        & (0.3462)\\   
      Landfall                               & 0.4481$^{***}$ & 0.4157$^{***}$  & 1.363$^{***}$\\   
                                             & (0.0683)       & (0.0650)        & (0.1631)\\   
      Landfalls Since 1980                   &                & -0.0831$^{***}$ & -0.0831$^{***}$\\   
                                             &                & (0.0265)        & (0.0265)\\   
      Threat $\times$ Landfalls Since 1980   &                &                 & 0.0662$^{*}$\\   
                                             &                &                 & (0.0319)\\   
      Landfall $\times$ Landfalls Since 1980 &                &                 & -0.0653$^{***}$\\   
...
\begin{table}[htbp]
   ...
   \begin{tabular}{lccc}
      \tabularnewline \midrule \midrule
      Dependent Variable: & \multicolumn{3}{c}{log(total\_rev\_per\_cap)}\\
      Model:                                                  & (1)            & (2)            & (3)\\  
      \midrule
      \emph{Variables}\\
      Hur\_Threat                                             & 0.1073         & -0.0129        & 1.155$^{***}$\\   
                                                              & (0.1564)       & (0.1616)       & (0.1954)\\   
      Hur\_Landfall                                           & 0.4481$^{***}$ & 0.5639$^{***}$ & -0.5641$^{**}$\\   
                                                              & (0.0683)       & (0.0653)       & (0.1926)\\   
      temp\_mean                                              & 0.0046$^{***}$ & 0.0066$^{***}$ & 0.0066$^{***}$\\   
                                                              & (0.0010)       & (0.0010)       & (0.0010)\\   
      total\_hist\_landfall                                   &                & -0.0779$^{**}$ & -0.0779$^{**}$\\   
                                                              &                & (0.0290)       & (0.0290)\\   
      years\_since\_landfall\_hur                             &                & 0.0065         & 0.0065\\   
                                                              &                & (0.0078)       & (0.0078)\\   
      Hur\_Threat $\times$ years\_since\_landfall\_hur        &                &                & -0.1341$^{***}$\\   
                                                              &                &                & (0.0220)\\   
      Hur\_Landfall $\times$ years\_since\_landfall\_hur      &                &                & 0.1278$^{***}$\\   
                                                              &                &                & (0.0192)\\   
      \midrule
      \emph{Fixed-effects}\\
      year                                                    & Yes            & Yes            & Yes\\  
...
\begin{figure}[h!]
    \centering
    \includegraphics[width =0.65\linewidth]{historical count hist.png}
    \caption{Histogram of Observation Level Total Landfalls}
    \label{fig:type_ci}
    \floatfoot{Note:}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width =0.65\linewidth]{years since hist.png}
    \caption{Histogram of Years Betwen Hurricanes}
    \label{fig:type_ci}
    \floatfoot{Note: }
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width =0.9\linewidth]{ES Agg Vol.png}
...
\begin{table}[t!]
   ...
   \begin{tabular}{lcc}
      ...
      \midrule
      \emph{Variables}\\
      Threat         & 0.0401$^{*}$   &0.1073   \\   
                     & (0.0193)       &(0.1564)   \\   
      Landfall       & 0.1962$^{***}$ & 0.4481$^{***}$  \\   
                     & (0.0606)       & (0.0683)  \\   
      temp\_mean     & 0.0046$^{***}$ & 0.0046$^{***}$\\   
                     & (0.0010)       & (0.0010)\\   
      \midrule
      \emph{Fit statistics}\\
      Observations   & 448,123        & 448,123\\  
...
\begin{sidewaystable}[t!]
   ...
   \begin{tabular}{lcccccc}
      ...
      \midrule
      \emph{Variables}\\
      Hur\_Threat                                             & 0.1073         & -0.0129        & 1.155$^{***}$   & 1.271$^{***}$   & -0.0162        & 1.435$^{**}$\\   
                                                              & (0.1564)       & (0.1616)       & (0.1954)        & (0.1938)        & (0.2339)       & (0.5516)\\   
      Hur\_Landfall                                           & 0.4481$^{***}$ & 0.5639$^{***}$ & -0.5641$^{**}$  & -0.7123$^{***}$ & 0.5344$^{***}$ & -0.9166\\   
                                                              & (0.0683)       & (0.0653)       & (0.1926)        & (0.1918)        & (0.0678)       & (0.5616)\\   
      temp\_mean                                              & 0.0046$^{***}$ & 0.0066$^{***}$ & 0.0066$^{***}$  & 0.0066$^{***}$  & 0.0066$^{***}$ & 0.0066$^{***}$\\   
                                                              & (0.0010)       & (0.0010)       & (0.0010)        & (0.0010)        & (0.0010)       & (0.0010)\\   
      total\_hist\_landfall                                   &                & -0.0779$^{**}$ & -0.0779$^{**}$  & -0.0893$^{**}$  & -0.0893$^{**}$ & -0.0893$^{**}$\\   
                                                              &                & (0.0290)       & (0.0290)        & (0.0303)        & (0.0303)       & (0.0303)\\   
      years\_since\_landfall\_hur                             &                & 0.0065         & 0.0065          & 0.0418$^{**}$   & 0.0418$^{**}$  & 0.0418$^{**}$\\   
                                                              &                & (0.0078)       & (0.0078)        & (0.0143)        & (0.0143)       & (0.0143)\\   
      Hur\_Threat $\times$ years\_since\_landfall\_hur        &                &                & -0.1341$^{***}$ & -0.1448$^{***}$ & 0.0144         & -0.1830\\   
                                                              &                &                & (0.0220)        & (0.0208)        & (0.0613)       & (0.1503)\\   
      Hur\_Landfall $\times$ years\_since\_landfall\_hur      &                &                & 0.1278$^{***}$  & 0.1412$^{***}$  &                & 0.1974\\   
                                                              &                &                & (0.0192)        & (0.0188)        &                & (0.1466)\\   
      yrs\_since\_hur\_sq                                     &                &                &                 & -0.0028$^{**}$  & -0.0028$^{**}$ & -0.0028$^{**}$\\   
                                                              &                &                &                 & (0.0009)        & (0.0009)       & (0.0009)\\   
      Hur\_Threat $\times$ yrs\_since\_hur\_sq                &                &                &                 &                 & -0.0013        & 0.0021\\   
                                                              &                &                &                 &                 & (0.0040)       & (0.0089)\\   
      Hur\_Landfall $\times$ yrs\_since\_hur\_sq              &                &                &                 &                 &                & -0.0033\\   
                                                              &                &                &                 &                 &                & (0.0085)\\   
      \midrule
      \emph{Fixed-effects}\\
      ...
      R$^2$                                                   & 0.77057        & 0.79157        & 0.79158         & 0.79303         & 0.79301        & 0.79303\\  
      \midrule \midrule
      \multicolumn{7}{l}{\emph{Clustered (fips \& year) standard-errors in parentheses}}\\
...
\begin{figure}[h!]
   \centering
	\begin{subfigure}{0.45\linewidth}
		\caption{1 to 2 Years}
		\includegraphics[width=\linewidth]{hist pl q1.png}
	\end{subfigure}
	\begin{subfigure}{0.45\linewidth}
		\caption{3 Years}
		\includegraphics[width=\linewidth]{hist pl q2.png}
	\end{subfigure}
		\begin{subfigure}{0.45\linewidth}
		\caption{4 to 6 Years}
		\includegraphics[width=\linewidth]{hist pl q3.png}
	\end{subfigure}
		\begin{subfigure}{0.45\linewidth}
		\caption{7 of More Years}
		\includegraphics[width=\linewidth]{hist pl q4.png}
	\end{subfigure}
    \caption{Placebo History}
    \label{fig:disc_full}
        \floatfoot{Note: Results from event study with subsets based on the years that have passed since that last storm made landfall in a county. The vertical axis represents total revenue per 100 thousand residents in USD. The horizontal axis represents weeks. Week 0 is the week that a tropical hurricane made landfall in a county. The bars represent the 5\% confidence interval around the point estimate.}
\end{figure}
...
\begin{figure}[h!]
   \centering
	\begin{subfigure}{0.45\linewidth}
		\caption{1 to 2 Years}
		\includegraphics[width=\linewidth]{year pl q1.png}
	\end{subfigure}
	\begin{subfigure}{0.45\linewidth}
		\caption{3 Years}
		\includegraphics[width=\linewidth]{year pl q2.png}
	\end{subfigure}
		\begin{subfigure}{0.45\linewidth}
		\caption{4 to 6 Years}
		\includegraphics[width=\linewidth]{year pl q3.png}
	\end{subfigure}
		\begin{subfigure}{0.45\linewidth}
		\caption{7 of More Years}
		\includegraphics[width=\linewidth]{year pl q4.png}
	\end{subfigure}
    \caption{Placebo By Years Between Subsequent Hurricanes}
    \label{fig:disc_full}
        \floatfoot{Note: Results from event study with subsets based on the years that have passed since that last storm made landfall in a county. The vertical axis represents total revenue per 100 thousand residents in USD. The horizontal axis represents weeks. Week 0 is the week that a tropical hurricane made landfall in a county. The bars represent the 5\% confidence interval around the point estimate.}
\end{figure}
