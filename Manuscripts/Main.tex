...
\begin{figure}[h!]
    \centering
    \includegraphics[width =0.9\linewidth]{historical count hist.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width =0.9\linewidth]{years since hist.png}
...
\begin{figure}[h!]
   \centering
	...
	\begin{subfigure}{0.75\linewidth}
		...
		\includegraphics[width=\linewidth]{Es hist major.png}
	\end{subfigure}
